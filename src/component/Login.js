...
if(data.email===getDataBox.email && data.password=== getDataBox.password){
         ...
         {view === "login"?
                      ...
                      <Flex justifyContent="center" >
                        <Box width={{ "base": "90%", md: "40%" }}>
                          <FormControl isRequired >
                            ...
                            <Input  {...register("email",{required:true})}  placeholder="Enter Email Address" />
          ...
          <InputGroup size='md'>
                <Input
                  ...
                  {...register("password",{required:true,maxLength:10,minLength:4,message:"password lenth must be greater than 4 and less than equlas to 10."})}
                />
                <br/>
          ...
          <Box bgColor={greenColor}>
            ...
            >
              ...
              <Box>
                ...
                >
                  Sign in your account and start your journey with yartiTech. we try our best to reach your goal,connect with us.........
                  <Text
                  fontSize="3xl"
                  color="black"
                  fontFamily="cursive"
...
<br/>
                ...
                fontFamily="cursive"
                fontWeight="light"
                >Designed by @ Bidhyanand poddar</Text>
